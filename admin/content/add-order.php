...
if (isset($_POST['add_order'])) {
    ...
    foreach ($id_service as $key => $value) {
        ...
        $insert_trans_order_detail = mysqli_query($config, "INSERT INTO trans_order_detail (id_order, id_service, qty, subtotal) VALUES ('$trans_order_id', '$id_service', '$qty', '$subtotal')");
    }
