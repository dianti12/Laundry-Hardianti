...
<div class="card mb-3">
    <div class="card-body">
        <img src="./img/pelanggan.jpg" class="card-img-top mx-auto d-block" style="width: 300px;" alt="Gambar Pelanggan">
        <div class="card-body text-center">
            <h5 class="card-title">SISTEM INFORMASI LAUNDRY HARDIANTI</h5>
            <p class="card-text fw-bold">Point of Sales System - Kelola Transaksi Laundry dengan Mudah</p>
        </div>
    </div>
    ...
    <div class="col-6">
        <div class="card text-center mb-3">
            <div class="card-body">
                ...
                <h3 class="card-title">
                    <img src="./img/trolley.png" class="card-img-top mx-auto d-block" style="width: 100px;" alt="Gambar Pelanggan">
                    TRANSAKSI BARU
                </h3>
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <select name="id_customer" class="form-control" required>
                            ...
                            <?php while ($rowCustomer = mysqli_fetch_assoc($queryCustomer)) : ?>
                                ...
                                <option data-phone='$phone' value="<?= $rowCustomer['id'] ?>"><?= $rowCustomer['phone'] ?></option>
                            <?php endwhile ?>
                        </select>
                    </div>
